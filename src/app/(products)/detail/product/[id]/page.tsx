...
export default async function ProductPageDetail({ params }: Params) {
  ...
  return (
    <div className="mx-auto mb-20 mt-20 flex w-full max-w-[600px] flex-col gap-6 rounded-lg bg-white p-4 shadow-xl">
      ...
      <div>
        ...
        <table className="w-full overflow-x-scroll p-4">
          <thead>
            <tr className="flex items-center justify-between border-2">
              <th className="w-[23.5%] border-2">Produto</th>
              <th className="w-[23.5%] border-2">Quantidade</th>
              <th className="w-[23.5%] border-2">Vencimento</th>
              <th className="w-[23.5%] border-2">Imagem</th>
            </tr>
          </thead>
          <tbody>
